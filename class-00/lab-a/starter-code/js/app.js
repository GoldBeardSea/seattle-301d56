...
function displayPics(){
  ...
  // the variable let makes the scope of rando to be within the function of displayPics making it inaccessable to the console log in the above line. If we leave it at var it will work otherwise .
  console.log(viewed);
